...
import { lessons } from "../../biology";




export const metadata = {
  title: "ثانوية بلس - الأحياء",
...
export default function Home() {
  return (
    ...
    >
      <h1 className="text-4xl font-bold mb-8 text-center">ثانوية بلس - الأحياء</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">

        {lessons.map((lesson) => (
          <Link key={lesson.id} href={`/biology/${lesson.id}`}>
