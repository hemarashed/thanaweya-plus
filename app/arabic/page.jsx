...
import { lessons } from "../../arabic";




export const metadata = {
  title: "ثانوية بلس - اللغة العربية",
...
export default function Home() {
  return (
    ...
    >
      <h1 className="text-4xl font-bold mb-8 text-center">ثانوية بلس - اللغة العربية</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">

        {lessons.map((lesson) => (
          <Link key={lesson.id} href={`/arabic/${lesson.id}`}>
